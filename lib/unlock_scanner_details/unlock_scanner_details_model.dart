...
import 'unlock_scanner_details_widget.dart' show UnlockScannerDetailsWidget;
import 'package:flutter/material.dart';

class UnlockScannerDetailsModel
    extends FlutterFlowModel<UnlockScannerDetailsWidget> {
  ...
  // Stores action output result for [Backend Call - API (Unlock Seal List)] action in Button widget.
  ApiCallResponse? apiResultxpi;
  bool isDataUploading_clickedPhotos = false;
  FFUploadedFile uploadedLocalFile_clickedPhotos =
