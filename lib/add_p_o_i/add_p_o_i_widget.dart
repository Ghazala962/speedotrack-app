...
import 'add_p_o_i_model.dart';
export 'add_p_o_i_model.dart';

class AddPOIWidget extends StatefulWidget {
  const AddPOIWidget({super.key});

  static String routeName = 'Add-POI';
  static String routePath = '/addPOI';
...
class _AddPOIWidgetState extends State<AddPOIWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddPOIModel());
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Container(
                            ...
                            child: custom_widgets.CreatePOI(
                              width: double.infinity,
                              height: double.infinity,
                              markerColor: FFAppState().markerColor,
                              markerIcon: _model
                                  .uploadedLocalFile_uploadDataMarkerIconAdd,
                            ),
                          ),
                        ),
                      ),
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      FFLocalizations.of(
                                                                              context)
                                                                          .getText(
                                                                        'jpw9944e' /* "Please add at least one group... */,
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (selectedMedia !=
                                                                          ...
                                                                          selectedMedia.every((m) => validateFileFormat(
                                                                              ...
                                                                              context))) {
                                                                        safeSetState(() =>
                                                                            _model.isDataUploading_uploadDataMarkerIconAdd =
                                                                                true);
                                                                        ...
                                                                        if (selectedUploadedFiles.length ==
                                                                          ...
                                                                          safeSetState(
                                                                              () {
                                                                            _model.uploadedLocalFile_uploadDataMarkerIconAdd =
                                                                                ...
                                                                                Theme(
                                                                                  ...
                                                                                  child: Checkbox(
                                                                                    ...
                                                                                    onChanged: (newValue) async {
                                                                                      safeSetState(() => _model.visibleValue = newValue!);
                                                                                      if (newValue!) {
                                                                                        FFAppState().poiVisible = true;
                                                                                        safeSetState(() {});
                                                                                      } else {
                                                                                        FFAppState().poiVisible = false;
                                                                                        safeSetState(() {});
                                                                                      }
                                                                                    },
                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            _model.addPoiResult =
                                                                                await NewSpeedotrackJSApiGroup.addPOIScreenCall.call(
                                                                              name: _model.nameTextController.text,
                                                                              visible: _model.visibleValue,
                                                                              lat: FFAppState().selectedLat.toString(),
                                                                              lng: FFAppState().selectedLng.toString(),
                                                                              jwt: FFAppState().userJwt,
                                                                              colour: functions.colorToString(_model.colorPicked!),
                                                                              image: _model.uploadedLocalFile_uploadDataMarkerIconAdd,
                                                                              radius: '1',
                                                                              group: _model.dropDownValue,
                                                                            );

                                                                            if ((_model.addPoiResult?.succeeded ??
                                                                                true)) {
