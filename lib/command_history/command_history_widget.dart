...
import 'command_history_model.dart';
export 'command_history_model.dart';
...
class CommandHistoryWidget extends StatefulWidget {
  ...
  static String routeName = 'Command_History';
  static String routePath = '/commandHistory';
...
class _CommandHistoryWidgetState extends State<CommandHistoryWidget> {
  late CommandHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommandHistoryModel());
              ...
              Expanded(
                child: Container(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    future: NewSpeedotrackJSApiGroup.commandListApiCall.call(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewCommandListApiResponse = snapshot.data!;

                      return Builder(
                        builder: (context) {
                          final subuser = getJsonField(
                            listViewCommandListApiResponse.jsonBody,
                            r'''$.results.commands''',
                          ).toList();
