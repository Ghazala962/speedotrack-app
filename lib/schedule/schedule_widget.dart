        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(30.0, 15.0, 20.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        'y37gkk3g' /* Command Type */,
                      ),
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(31.0, 0.0, 0.0, 0.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        'fau07698' /* Previous schedule will be over... */,
                      ),
