...
import 'add_command_model.dart';
export 'add_command_model.dart';

class AddCommandWidget extends StatefulWidget {
  const AddCommandWidget({super.key});
...
class _AddCommandWidgetState extends State<AddCommandWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddCommandModel());
