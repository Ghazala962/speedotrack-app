...
import 'group_modal_model.dart';
export 'group_modal_model.dart';
...
class _GroupModalWidgetState extends State<GroupModalWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GroupModalModel());
