...
class Home15TravelWidget extends StatefulWidget {
  const Home15TravelWidget({super.key});

  static String routeName = 'Home15Travel';
  static String routePath = '/home15Travel';

  @override
  State<Home15TravelWidget> createState() => _Home15TravelWidgetState();
}
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          child: wrapWithModel(
                                            model: _model.playbackComModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: PlaybackComWidget(),
                                          ),
                                        ),
                                      ],
                                    ),
