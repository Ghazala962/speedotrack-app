...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    speedotrackGPSProAuthUserSubject.add(
      SpeedotrackGPSProAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SpeedotrackGPSProAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SpeedotrackGPSProAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SpeedotrackGPSProAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    speedotrackGPSProAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SpeedotrackGPSProAuthUser? currentUser;
