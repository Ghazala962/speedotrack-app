...
class AddNewTripWidget extends StatefulWidget {
  const AddNewTripWidget({super.key});

  static String routeName = 'add_new_trip';
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '4rx7pbb8' /* EWAY Bill Expiry Date */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                                          ...
                                                          children: [
                                                            Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '6phi3myr' /* Select Bill Expiry Date  */,
                                                              ),
